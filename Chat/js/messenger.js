$(document).ready(function () {
  ...
  function HomeView() {
    ...
    chatButton.click(function (event) {
      if(usernameInput.val() != '' && $.inArray(usernameInput.val(), userList) == -1) {
        ...
        window.alert("Sorry, Name Already taken please");
      }
    });
  };
  ...
  ChatView.prototype.handleMessage = function (message, animate) {
    ...
    if (isBlurred) {
      ...
      timerId = setInterval(function () {
        document.title = document.title == "Chat" ? "New Message" : "Chat";
      }, 2000);
